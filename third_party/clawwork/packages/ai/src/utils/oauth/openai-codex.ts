...
function getCallbackHost(): string {
	return getProviderEnvValue("CLAWWORK_OAUTH_CALLBACK_HOST") ?? getProviderEnvValue("PI_OAUTH_CALLBACK_HOST") ?? "127.0.0.1";
}
 ...
 * @param options.originator - OAuth originator parameter (defaults to "clawwork")
 */
