...
function addCustomHeadersMiddleware(client: BedrockRuntimeClient, headers: Record<string, string>): void {
	...
	client.middlewareStack.add(middleware, { step: "build", name: "clawwork-ai-custom-headers", priority: "low" });
}
...
function resolveCacheRetention(cacheRetention?: CacheRetention, env?: ProviderEnv): CacheRetention {
	...
	if ((getProviderEnvValue("CLAWWORK_CACHE_RETENTION", env) ?? getProviderEnvValue("PI_CACHE_RETENTION", env)) === "long") {
		return "long";
	}
	return "short";
}
