...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/ClawHunt-Store/SuperClaw/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.CLAWWORK_PACKAGE_DIR ?? process.env.PI_PACKAGE_DIR;
	if (envDir) {
...
export const APP_NAME: string = piConfigName || "clawwork";
export const APP_TITLE: string = piConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".clawwork";
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.CLAWWORK_SHARE_VIEWER_URL ?? process.env.PI_SHARE_VIEWER_URL ?? DEFAULT_SHARE_VIEWER_URL;
