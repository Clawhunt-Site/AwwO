...
const MIGRATION_GUIDE_URL =
	"https://github.com/ClawHunt-Store/SuperClaw/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/ClawHunt-Store/SuperClaw/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 *
 * See: https://github.com/ClawHunt-Store/SuperClaw
 */
