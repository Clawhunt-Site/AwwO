...
> **ClawWork is a hard fork of Pi vendored into and maintained inside SuperClaw**
> (see `NOTICE`). Report security issues in this harness through the SuperClaw
> repository (`ClawHunt-Store/SuperClaw`), NOT to the upstream Pi/Earendil
> contacts below. The original upstream policy is retained unchanged for
