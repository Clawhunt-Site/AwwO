import { createDemoService } from '../../../a784236e-c48a-468d-b14f-8392297e0452/src/demo.js';
...
await writeFile(new URL('./contract-review-repro.json', import.meta.url), `${JSON.stringify(result, null, 2)}\n`);
