...
func TestGraphOutputPolicyMatchesValidation(t *testing.T) {
	for _, test := range []struct {
		...
		{"single-html", []graphField{{ID: "page", Type: "html", Required: true}}, "<html><head></head><body>Result</body></html>", "<h1>fragment</h1>", true},
		{"single-fenced-html", []graphField{{ID: "page", Type: "html", Required: true}}, "```html\n<html><head></head><body>Result</body></html>\n```", "```html\n<h1>fragment</h1>\n```", true},
		{"multi-html", []graphField{{ID: "page", Type: "html", Required: true}, {ID: "note", Type: "text"}}, `{"page":"<html><head></head><body>Result</body></html>"}`, "<html><head></head><body>Result</body></html>", false},
