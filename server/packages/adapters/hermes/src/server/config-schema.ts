  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Resume Hermes sessions across SuperClaw heartbeats.",
      },
      {
        key: "worktreeMode",
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Pass Hermes --quiet for cleaner SuperClaw run transcripts.",
      },
      {
        key: "verbose",
      ...
      },
      {
        ...
        type: "text",
        hint: "Optional API base override. Defaults to SUPERCLAW_API_URL (legacy PAPERCLIP_API_URL also accepted).",
      },
      {
        key: "promptTemplate",
