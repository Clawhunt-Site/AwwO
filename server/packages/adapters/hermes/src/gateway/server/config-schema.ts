  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        hint: "Hermes API_SERVER_KEY. Stored as a SuperClaw secret reference.",
        meta: { secret: true },
      },
      {
      ...
      },
      {
        ...
        type: "text",
        hint: "Optional Runtime API URL reachable by the remote Hermes host. This is not a credential.",
      },
      {
        key: "headers",
        label: "Extra headers",
