  ...
  return {
    fields: [
      ...
      },
      {
        ...
        hint: "Fallback if the ACP agent asks for input outside an interactive session. SuperClaw still auto-approves permissions by default.",
      },
      {
        key: "cwd",
        label: "Working directory",
        type: "text",
        hint: "Absolute fallback directory. SuperClaw execution workspaces can override this at runtime.",
      },
      {
        key: "stateDir",
        label: "State directory",
        type: "text",
        hint: "Optional ACPX session state directory. Defaults to SuperClaw-managed company/agent scoped storage.",
      },
      {
        key: "fastMode",
