...
Use when:
- You want SuperClaw to invoke OpenClaw over the Gateway WebSocket protocol.
...
- Your deployment does not permit outbound WebSocket access from the SuperClaw server.
...
- paperclipApiUrl (string, optional): absolute SuperClaw base URL advertised in wake text
...
Wake payload notes:
- SuperClaw wake context is embedded into the generated message text
