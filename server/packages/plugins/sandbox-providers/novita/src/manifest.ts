...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "Sandbox provider plugin that provisions Novita Agent Sandbox environments for SuperClaw agent runs.",
  author: "Novita AI",
      ...
      configSchema: {
        ...
        properties: {
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific Novita API key. Paste a key or an existing SuperClaw secret reference; saved environments store pasted values as company secrets. Falls back to NOVITA_API_KEY if omitted.",
          },
          domain: {
            type: "string",
            description:
          ...
          reuseLease: {
            ...
            default: false,
            description:
              "Pause and later resume the sandbox across SuperClaw runs instead of killing it on release.",
          },
        },
      },
    },
