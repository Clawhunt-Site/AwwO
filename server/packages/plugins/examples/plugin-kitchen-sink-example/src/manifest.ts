...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current SuperClaw plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "SuperClaw",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the SuperClaw domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
