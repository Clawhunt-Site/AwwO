...
export async function onboard(opts: OnboardOptions): Promise<void> {
  ...
  if (existingConfig) {
    p.log.message(
      pc.dim("Existing SuperClaw install detected; keeping the current configuration unchanged."),
    );
    ...
    p.outro("Existing SuperClaw setup is ready.");
    return;
  }
