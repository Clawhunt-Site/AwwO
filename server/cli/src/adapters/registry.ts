...
import { printClawworkStreamEvent } from "@paperclipai/adapter-clawwork-local/cli";
...
const clawworkLocalCLIAdapter: CLIAdapterModule = {
  type: "clawwork_local",
  formatStdoutEvent: printClawworkStreamEvent,
};
