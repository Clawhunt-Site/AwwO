...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from SuperClaw");
  lines.push("");
  ...
  // Footer
  lines.push("---");
  lines.push(`Exported from SuperClaw on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
