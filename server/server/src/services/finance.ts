...
// Shared with costService.createEvent — both event tables carry the same set of
// NO ACTION FKs, and both must refuse cross-company references at the write layer.
