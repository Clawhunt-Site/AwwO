...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "The workspace needs a disposition before this issue can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "The workspace could not resolve this issue's missing disposition automatically. The issue is blocked on a recovery owner.";
...
export function isSuccessfulRunHandoffRequiredNoticeBody(body: string) {
  ...
  return trimmed === SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY ||
    trimmed === LEGACY_SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY ||
...
export function buildSuccessfulRunHandoffInstruction(input: {
  ...
  return [
    `Your previous run on ${issueLabel} succeeded, but the issue is still in \`in_progress\` and the workspace cannot identify a valid issue disposition.`,
    "",
    "Resolve the missing disposition before creating or revising any new artifacts. Choose **exactly one** outcome and perform the matching workspace action:",
    "",
