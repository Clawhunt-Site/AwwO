  ...
  return {
    ...
    createTrigger: async (
      ...
      if (input.kind === "webhook") {
        ...
        secretMaterial = {
          webhookUrl: `${(process.env.SUPERCLAW_API_URL || process.env.PAPERCLIP_API_URL)}/api/routine-triggers/public/${publicId}/fire`,
    ...
    rotateTriggerSecret: async (
      ...
      return {
        trigger: trigger as RoutineTrigger,
        secretMaterial: {
          webhookUrl: `${(process.env.SUPERCLAW_API_URL || process.env.PAPERCLIP_API_URL)}/api/routine-triggers/public/${existing.publicId}/fire`,
