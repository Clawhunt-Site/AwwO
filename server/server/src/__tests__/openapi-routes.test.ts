...
const explicitOpenApiCoverageExclusions = new Set([
  ...
  "pipelines.ts",
  // Capability-workshop surface contracts (mirror of the kernel's /api/contracts/* and
  // /api/plugins/*-catalog) — migrated incrementally and not yet in the public OpenAPI
  // document. Backlog: document them in buildOpenApiSpec.
  "workshop-contracts.ts",
]);
...
describe("openapi routes", () => {
  it("serves the generated OpenAPI document", async () => {
    ...
    expect(res.body.info.title).toBe("SuperClaw API");
