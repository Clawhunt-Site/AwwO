...
describe("buildInviteOnboardingTextDocument", () => {
  it("renders a plain-text onboarding doc with expected endpoint references", () => {
    ...
    expect(text).toContain("SuperClaw Agent Onboarding");
    ...
    expect(text).toContain("Suggested SuperClaw base URLs to try");
    ...
    expect(text).toContain("Hermes-originated SuperClaw API usage");
    ...
    expect(text).toContain("Decide which SuperClaw adapter type matches your runtime.");
  });
