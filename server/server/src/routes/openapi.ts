...
function applyDocumentFixups(document: any): any {
  ...
  document.components.securitySchemes = {
    [BOARD_SESSION_AUTH_SCHEME]: {
      ...
      description:
        "Board session cookie in authenticated mode. SuperClaw uses Better Auth; cookie transport may vary by deployment.",
    },
    ...
    [AGENT_BEARER_AUTH_SCHEME]: {
      ...
      description:
        "Agent API key or SuperClaw-issued local agent JWT presented in the Authorization bearer header.",
    },
  };
...
export function buildOpenApiDocument(): any {
  return applyDocumentFixups({
    ...
    info: {
      title: "SuperClaw API",
      version: "1.0.0",
      description: "REST API for the SuperClaw AI agent management platform",
    },
    servers: [{ url: "/" }],
