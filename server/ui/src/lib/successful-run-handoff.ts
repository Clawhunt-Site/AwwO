...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "This issue needs a disposition before it can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "The missing disposition could not be resolved automatically. The issue is blocked on a recovery owner.";
...
export function isSuccessfulRunHandoffComment(text: string) {
  ...
  return trimmed === SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY
    || /^Paperclip needs a disposition before this issue can continue\./i.test(trimmed)
