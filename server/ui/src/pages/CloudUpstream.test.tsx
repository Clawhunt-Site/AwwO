...
describe("CloudUpstream", () => {
  ...
  it("sends a company-prefixed redirectUri when starting Connect", async () => {
    ...
    const input = container.querySelector<HTMLInputElement>("input[aria-label='Cloud stack URL']");
  ...
  it("uses the URL pathname prefix when cleaning up the callback URL with no company context", async () => {
    ...
    mockCloudUpstreamsApi.finishConnect.mockResolvedValue({
      ...
      target: {
        stackId: "stack-1",
        stackSlug: "stack",
        stackDisplayName: "Workspace Cloud",
    ...
    connections: [
      {
        id: "connection-1",
        companyId: "company-1",
        remoteUrl: "https://workspace.example/PAP",
        target: {
          stackId: "stack-1",
          stackSlug: "stack",
          stackDisplayName: "Workspace Cloud",
          companyId: "cloud-company-1",
          primaryHost: "workspace.example",
...
function buildRun(input: {
  ...
  return {
    ...
    targetUrl: "https://workspace.example",
    report: input.report ?? {},
    retryOfRunId: null,
    createdAt: "2026-05-18T18:00:00.000Z",
