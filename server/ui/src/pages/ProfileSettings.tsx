...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in workspace file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into workspace storage.";
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <Avatar size="lg" className="data-[size=lg]:size-24 ring-4 ring-background shadow-xl">
                    {currentImage ? <AvatarImage src={resolveContentUrl(currentImage)} alt={currentName} /> : null}
