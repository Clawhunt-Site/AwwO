...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("```bash");
  lines.push("# Import this package through the workspace import flow");
  lines.push("```");
  lines.push("");
  lines.push("See the workspace documentation for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from this workspace on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
