    ...
    <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_320px]">
          <div className="p-6 sm:p-7">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
              Replaces the current pattern where a system warning renders inside a user-style
      ...
      >
        <div className="space-y-4 rounded-2xl border border-border/70 bg-background/70 p-4">
          ...
          <SystemNotice
            tone="danger"
            label="Paperclip alert"
            source={{ label: "Paperclip", href: "/PAP/agents" }}
            timestamp="2026-05-04T16:48:00.000Z"
            body="The missing disposition could not be resolved automatically. The issue is blocked on a recovery owner."
            metadata={[
              {
      ...
      <div className="grid gap-5 xl:grid-cols-2">
        ...
        >
          <div className="space-y-3 rounded-2xl border border-border/70 bg-background/70 p-4">
            ...
            <p className="px-1 text-xs text-muted-foreground">
              ...
              author is the system. Two containers stack the warning inside a user-style
        ...
        <LabSection
          eyebrow="After"
          title="Paperclip notice replacement"
        ...
        >
          <div className="space-y-3 rounded-2xl border border-border/70 bg-background/70 p-4">
            ...
            <p className="px-1 text-xs text-muted-foreground">
              ...
              evidence. Tone is reinforced by the octagon icon and the &quot;Paperclip alert&quot; label,
              not just red.
            </p>
          </div>
        </LabSection>
