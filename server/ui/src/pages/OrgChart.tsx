...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: localize({ en: "Org Chart", zh: "组织图" }) }]);
  ...
  if (!selectedCompanyId) {
    return (
      <EmptyState
        icon={Network}
        message={localize({ en: "Select a company to view the org chart.", zh: "选择一个公司查看组织图。" })}
      />
    );
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return (
      <EmptyState
        icon={Network}
        message={localize({ en: "No organizational hierarchy defined.", zh: "尚未定义组织层级。" })}
      />
    );
  }
      ...
      <div className="mb-2 flex shrink-0 flex-wrap items-center justify-start gap-2">
        <Link to="/company/import">
          <Button variant="outline" size="sm">
            ...
            {localize({ en: "Import company", zh: "导入公司" })}
          </Button>
        </Link>
        <Link to="/company/export">
          <Button variant="outline" size="sm">
            <Download className="mr-1.5 h-3.5 w-3.5" />
            {localize({ en: "Export company", zh: "导出公司" })}
          </Button>
        </Link>
      </div>
      <div
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          <button
            ...
            title={localize({ en: "Zoom in", zh: "放大" })}
            aria-label={localize({ en: "Zoom in", zh: "放大" })}
          >
          ...
          <button
            ...
            title={localize({ en: "Zoom out", zh: "缩小" })}
            aria-label={localize({ en: "Zoom out", zh: "缩小" })}
          >
          ...
          <button
            ...
            onClick={fitToScreen}
            title={localize({ en: "Fit to screen", zh: "适应屏幕" })}
            aria-label={localize({ en: "Fit chart to screen", zh: "让组织图适应屏幕" })}
          >
