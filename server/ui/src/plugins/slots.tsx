...
import { frontDoorOrigin } from "@/api/client";
...
function buildPluginUiUrl(contribution: PluginUiContribution): string {
  ...
  return `${frontDoorOrigin()}/_plugins/${encodeURIComponent(contribution.pluginId)}/ui/${contribution.uiEntryFile}?v=${cacheHint}`;
}
