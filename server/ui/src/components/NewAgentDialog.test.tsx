...
describe("NewAgentDialog", () => {
  ...
  beforeEach(() => {
    ...
    createCompanyInviteMock.mockResolvedValue({
      id: "invite-1",
      token: "agent-token",
      inviteUrl: "https://workspace.local/invite/agent-token",
      expiresAt: "2026-04-20T00:00:00.000Z",
      allowedJoinTypes: "agent",
      humanRole: null,
      onboardingTextUrl: "https://workspace.local/api/invites/agent-token/onboarding.txt",
      onboardingTextPath: "/api/invites/agent-token/onboarding.txt",
    });
    getInviteOnboardingMock.mockResolvedValue({
      onboarding: {
        connectivity: {
          connectionCandidates: ["https://workspace.local"],
          testResolutionEndpoint: {
            url: "https://workspace.local/api/invites/agent-token/test-resolution",
          },
        },
      },
    });
