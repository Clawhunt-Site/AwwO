...
export function MetricCard({ icon: Icon, value, label, description, to, onClick }: MetricCardProps) {
  ...
  const inner = (
    <div className={`h-full px-4 py-4 sm:px-5 sm:py-5 rounded-xl border border-border bg-card/60 shadow-sm transition-colors${isClickable ? " hover:bg-accent/50 cursor-pointer" : ""}`}>
