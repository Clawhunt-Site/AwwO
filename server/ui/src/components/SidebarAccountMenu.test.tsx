...
describe("SidebarAccountMenu", () => {
  ...
  it("removes docs, feedback, and version in an embedded host", async () => {
    const root = createRoot(container);
    const queryClient = new QueryClient({
      defaultOptions: { queries: { retry: false } },
    });
    ...
    expect(document.body.querySelector('a[href="https://docs.paperclip.ing/"]')).toBeNull();
  ...
  it("localizes the local board account trigger in Chinese", async () => {
