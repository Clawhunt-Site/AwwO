...
describe("MarkdownEditor", () => {
  ...
  it("keeps plugin slash queries active across spaces", () => {
    expect(findMentionMatch("/plugin:my plugin", "/plugin:my plugin".length)).toEqual({
      trigger: "skill",
      marker: "/",
      query: "plugin:my plugin",
      atPos: 0,
      endPos: "/plugin:my plugin".length,
    });
  });
