...
function CommandDialog({
  ...
  const resolvedTitle = title ?? localize({ en: "Command Palette", zh: "命令面板" })
  const resolvedDescription = description ?? localize({ en: "Search for a command to run...", zh: "搜索要执行的命令..." })
  const closeLabel = localize({ en: "Close", zh: "关闭" })
