        ...
        <div className="border-t border-border bg-popover px-3 py-2">
          ...
          <div className="mb-1.5 flex items-center gap-1.5">
            <Avatar size="xs" className="shrink-0">
              {currentUser.image ? <AvatarImage src={resolveContentUrl(currentUser.image)} alt={currentUser.name} /> : null}
        ...
        <span className="flex min-w-0 items-center gap-1.5">
          <Avatar size="xs" className="shrink-0">
            {author.role === "agent" ? (
              ...
              <>
                {author.imageUrl ? <AvatarImage src={resolveContentUrl(author.imageUrl)} alt={author.name} /> : null}
